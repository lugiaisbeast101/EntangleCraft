...
import net.minecraft.src.lambdaMod.*;
import net.minecraft.src.lambdaMod.SoundHandling.LambdaSoundHandler;
import net.minecraft.src.lambdaMod.blocks.*;
import net.minecraft.src.lambdaMod.gui.EnumGui;
import net.minecraft.src.lambdaMod.generation.*;
import net.minecraft.src.lambdaMod.items.EntangleCraftItems;
import net.minecraft.src.lambdaMod.items.ItemDevice;
import net.minecraft.src.lambdaMod.items.ItemLambda;
import net.minecraft.src.lambdaMod.items.ItemShard;
...
public class EntangleCraft implements IConnectionHandler
{
	...
	@SidedProxy(clientSide = "net.minecraft.src.lambdaMod.ClientProxy", serverSide = "net.minecraft.src.lambdaMod.CommonProxy")
