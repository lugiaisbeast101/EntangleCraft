...
public class Destination {
	...
	public Destination(double[] destPos, int[] blockPos, int channel, int dimension){
	...
	public Destination(int[] blockPos, int channel, int dimension){
		...
		if (o instanceof Destination)
			{
				...
				equality = equality && this.dimension == dest.dimension;
			}
		}
		return equality;
	}
	...
	public String toString(){
		String s;
		s = "Destination at Block coordinates " + this.blockCoords[0] + " " + this.blockCoords[1] + " " + this.blockCoords[2] + " in dimension " + dimension;
		return s;
	}
}
