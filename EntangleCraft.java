...
import net.minecraft.entanglecraft.*;
import net.minecraft.entanglecraft.SoundHandling.LambdaSoundHandler;
import net.minecraft.entanglecraft.blocks.*;
import net.minecraft.entanglecraft.gui.EnumGui;
import net.minecraft.entanglecraft.generation.*;
import net.minecraft.entanglecraft.items.EntangleCraftItems;
import net.minecraft.entanglecraft.items.ItemDevice;
import net.minecraft.entanglecraft.items.ItemLambda;
import net.minecraft.entanglecraft.items.ItemShard;
  ...
  */
  ...
  {	
	...
	if (EntangleCraft.proxy.isServer){  
  	...
  	try{
      thePlayer.serverForThisPlayer.setPlayerLocation(destinationPoints[0], destinationPoints[1]-1.65, destinationPoints[2], par3EntityPlayer.rotationYaw, par3EntityPlayer.rotationPitch);
...
@Override
public void clientLoggedIn(NetHandler clientHandler, NetworkManager manager,
		Packet1Login login) {
	// TODO Auto-generated method stub
