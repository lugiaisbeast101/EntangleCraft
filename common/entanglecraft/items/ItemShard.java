    ...
    {	
		...
		if (EntangleCraft.proxy.isServer){
			if (type == 3){
				...
				if (coords != null){
					ChunkCoordinates theCoords = thePlayer.verifyRespawnCoordinates(world, coords, true); // Not sure what the boolean here does
					...
					double expZ = thePlayer.posZ;
			          ...
			          if (distance != 0) world.createExplosion(thePlayer, expX, expY, expZ, (float)distance, true);
