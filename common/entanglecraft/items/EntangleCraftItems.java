...
public static void addItems(){
    ...
    GameRegistry.addRecipe(new ItemStack(EntangleCraftBlocks.BlockLambdaMiner,1), new Object[] {"FCF","TLT","FDF",Character.valueOf('D'), Item.pickaxeDiamond, Character.valueOf('F'), EntangleCraftBlocks.BlockFObsidian,Character.valueOf('L'), ItemLambdaCore, Character.valueOf('C'), ItemCircuit, Character.valueOf('T'), ItemTransmitter});
